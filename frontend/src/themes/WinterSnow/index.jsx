import '../DustyBlue/DustyBlue.css'
import '../_cinematic/cinematic.css'
import './WinterSnow.css'
...
const SnowScene = lazy(() => import('./SnowScene.jsx'))
...
export default function WinterSnow({ invitation, guestName }) {
  const couple = invitation.couple || {}
  const akad = (invitation.events || []).find(e => e.event_type === 'akad')
  const [quality, setQuality] = useState('high')

  return (
    <div className={`dusty-blue snow-3d cc-root cc-q-${quality}`}>
      <Suspense fallback={null}>
        <SnowScene quality={quality} onQuality={setQuality} />
      </Suspense>
