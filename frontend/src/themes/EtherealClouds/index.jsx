import '../IvoryClassic/IvoryClassic.css'
import '../_cinematic/cinematic.css'
import './EtherealClouds.css'
...
const CloudScene = lazy(() => import('./CloudScene.jsx'))
...
export default function EtherealClouds({ invitation, guestName }) {
  const couple = invitation.couple || {}
  const akad = (invitation.events || []).find(e => e.event_type === 'akad')
  const [quality, setQuality] = useState('high')

  return (
    <div className={`ivory-classic clouds-3d cc-root cc-q-${quality}`}>
      <Suspense fallback={null}>
        <CloudScene quality={quality} onQuality={setQuality} />
      </Suspense>
