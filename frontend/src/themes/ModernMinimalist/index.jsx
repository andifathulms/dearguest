...
export default function ModernMinimalist({ invitation, guestName }) {
  ...
  return (
    <div className="modern-minimalist">
      ...
      {invitation.closing_text && (
        <motion.section
          style={{ textAlign: 'center', padding: '4rem 2rem', color: 'var(--text-muted)', fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: 300 }}
          initial={{ opacity: 0 }}
