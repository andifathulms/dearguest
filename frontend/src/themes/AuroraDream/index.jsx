...
const AuroraScene = lazy(() => import('./AuroraScene.jsx'))
...
export default function AuroraDream({ invitation, guestName }) {
  const couple = invitation.couple || {}
  const akad = (invitation.events || []).find(e => e.event_type === 'akad')
  const [quality, setQuality] = useState('high')

  return (
    <div className={`midnight-celestial aurora-3d cc-root cc-q-${quality}`}>
      <Suspense fallback={null}>
        <AuroraScene quality={quality} onQuality={setQuality} />
      </Suspense>
