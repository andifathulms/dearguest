import '../LuxuryEmerald/LuxuryEmerald.css'
import '../_cinematic/cinematic.css'
import './EnchantedFireflies.css'
...
const FireflyScene = lazy(() => import('./FireflyScene.jsx'))
...
export default function EnchantedFireflies({ invitation, guestName }) {
  const couple = invitation.couple || {}
  const akad = (invitation.events || []).find(e => e.event_type === 'akad')
  const [quality, setQuality] = useState('high')

  return (
    <div className={`luxury-emerald fireflies-3d cc-root cc-q-${quality}`}>
      <Suspense fallback={null}>
        <FireflyScene quality={quality} onQuality={setQuality} />
      </Suspense>
