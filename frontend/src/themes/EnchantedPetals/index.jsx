import '../FloralLight/FloralLight.css'
import '../_cinematic/cinematic.css'
import './EnchantedPetals.css'
...
const PetalScene = lazy(() => import('./PetalScene.jsx'))
...
export default function EnchantedPetals({ invitation, guestName }) {
  const couple = invitation.couple || {}
  const akad = (invitation.events || []).find(e => e.event_type === 'akad')
  const [quality, setQuality] = useState('high')

  return (
    <div className={`floral-light petals-3d cc-root cc-q-${quality}`}>
      <Suspense fallback={null}>
        <PetalScene quality={quality} onQuality={setQuality} />
      </Suspense>
